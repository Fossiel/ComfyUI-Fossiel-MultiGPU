...
class FossielWanVideoModelLoader:
    @classmethod
    def INPUT_TYPES(s):
...
class FossielWanVideoVAELoader:
    @classmethod
    def INPUT_TYPES(s):
        devices = get_device_list()
...
class FossielLoadWanVideoT5TextEncoder:
    @classmethod
    def INPUT_TYPES(s):
        devices = get_device_list()
...
class FossielWanVideoTextEncode:
    @classmethod
    def INPUT_TYPES(s):
        devices = get_device_list()
...
class FossielLoadWanVideoClipTextEncoder:
    @classmethod
    def INPUT_TYPES(s):
        devices = get_device_list()
...
class FossielWanVideoModelLoader_2:
    @classmethod
    def INPUT_TYPES(s):
        return FossielWanVideoModelLoader.INPUT_TYPES()
    
    RETURN_TYPES = FossielWanVideoModelLoader.RETURN_TYPES
    RETURN_NAMES = FossielWanVideoModelLoader.RETURN_NAMES
    FUNCTION = "loadmodel"
    CATEGORY = "WanVideoWrapper"
    ...
    def loadmodel(self, model, base_precision, device, quantization,
        ...
        loader = FossielWanVideoModelLoader()
...
class FossielWanVideoVACEEncode:
    @classmethod
    def INPUT_TYPES(s):
        from nodes import NODE_CLASS_MAPPINGS
...
class FossielWanVideoBlockSwap:
    @classmethod
    def INPUT_TYPES(s):
        devices = get_device_list()
