...
<p align="center">
  <img src="https://raw.githubusercontent.com/Fossiel/ComfyUI-Fossiel-MultiGPU/main/assets/distorch2_0.gif" width="800">
  <br>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/Fossiel/ComfyUI-Fossiel-MultiGPU/main/assets/distorch_node.png" width="400">
  <br>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/Fossiel/ComfyUI-Fossiel-MultiGPU/main/assets/distorch2_0.png" width="300">
  <br>
...
Clone [this repository](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU) inside `ComfyUI/custom_nodes/`.
...
- [Default DisTorch2 Workflow](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/distorch2/default_DisTorch2.json)
- [FLUX.1-dev Example](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/distorch2/flux_dev_example_DisTorch2.json)
- [Hunyuan GGUF Example](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/distorch2/hunyuan_gguf_DisTorch2.json)
- [LTX Video Text-to-Video](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/distorch2/ltxv_text_to_video_MultiGPU.json)
- [Qwen Image Basic Example](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/distorch2/qwen_image_basic_example_DisTorch2.json)
- [WanVideo 2.2 Example](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/distorch2/wan2_2_example_DisTorch2.json)

### WanVideoWrapper

- [WanVideo T2V Example](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/wannvideowrapper/wanvideo_T2V_example_MultiGPU.json)
- [WanVideo 2.2 I2V Example](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/wannvideowrapper/wanvideo2_2_I2V_A14B_example_WIP_Multigpu.json)

### MultiGPU

- [FLUX.1-dev Example](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/multiGPU/flux_dev_example_MultiGPU.json)
- [SDXL 2-GPU](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/multiGPU/sdxl_2gpu.json)

### Florence2

- [Florence2, FLUX.1-dev, LTX Video Pipeline](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/florence2/florence2_flux1dev_ltxv_cpu_2gpu.json)

### GGUF

- [FLUX.1-dev 2-GPU GGUF](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/gguf/flux1dev_2gpu_gguf.json)
- [Hunyuan 2-GPU GGUF](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/gguf/hunyuan_2gpu_gguf.json)
- [Hunyuan CPU+GPU GGUF](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/gguf/hunyuan_cpu_1gpu_gguf.json)
- [Hunyuan GGUF DisTorch](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/gguf/hunyuan_gguf_distorch.json)
- [Hunyuan GGUF MultiGPU](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/gguf/hunyuan_gguf_MultiGPU.json)

### HunyuanVideoWrapper

- [HunyuanVideoWrapper Native VAE](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/hunyuanvideowrapper/hunyuanvideowrapper_native_vae.json)
- [HunyuanVideoWrapper Select Device](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/hunyuanvideowrapper/hunyuanvideowrapper_select_device.json)

### DisTorch (Legacy GGUF)

- [FLUX.1-dev GGUF DisTorch](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/distorch/flux1dev_gguf_distorch.json)
- [Hunyuan IP2V GGUF DisTorch](https://github.com/Fossiel/ComfyUI-Fossiel-MultiGPU/blob/main/examples/distorch/hunyuan_ip2v_distorch_gguf.json)
