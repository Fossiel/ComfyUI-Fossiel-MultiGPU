...
class FossielDeviceSelectorMultiGPU:
    @classmethod
    def INPUT_TYPES(s):
...
class FossielHunyuanVideoEmbeddingsAdapter:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
class FossielUnetLoaderGGUFAdvanced(FossielUnetLoaderGGUF):
    @classmethod
    def INPUT_TYPES(s):
        unet_names = [x for x in folder_paths.get_filename_list("unet_gguf")]
        return {
...
class FossielDualCLIPLoaderGGUF(FossielCLIPLoaderGGUF):
    @classmethod
    def INPUT_TYPES(s):
        import nodes
...
class FossielTripleCLIPLoaderGGUF(FossielCLIPLoaderGGUF):
    @classmethod
    def INPUT_TYPES(s):
        file_options = (s.get_filename_list(), )
        return {
...
class FossielQuadrupleCLIPLoaderGGUF(FossielCLIPLoaderGGUF):
    @classmethod
    def INPUT_TYPES(s):
        file_options = (s.get_filename_list(), )
        return {
...
class FossielFlorence2ModelLoader:
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {
...
class FossielDownloadAndLoadFlorence2Model:
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {
            "model": (
...
class FossielCheckpointLoaderNF4:
    @classmethod
    def INPUT_TYPES(s):
...
class FossielLoadFluxControlNet:
    @classmethod
    def INPUT_TYPES(s):
...
class FossielMMAudioModelLoader:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
class FossielMMAudioFeatureUtilsLoader:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
class FossielPulidInsightFaceLoader:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
class FossielPulidEvaClipLoader:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {},
...
class FossielHyVideoModelLoader:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
class FossielDownloadAndLoadHyVideoTextEncoder:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
